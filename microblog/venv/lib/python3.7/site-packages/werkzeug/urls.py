...
def url_join(base, url, allow_fragments=True):
    """Join a base.html URL and a possibly relative URL to form an absolute
    interpretation of the latter.

    :param base: the base.html URL for the join operation.
...
class Href(object):
    """Implements a callable that constructs URLs with the given base.html. The
