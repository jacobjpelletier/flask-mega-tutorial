...
def extract_path_info(
    ...
    Instead of providing a base.html URL you can also pass a WSGI environment.

    :param environ_or_baseurl: a WSGI environment dict, a base.html URL or
                               base.html IRI.  This is the root of the
                               application.
