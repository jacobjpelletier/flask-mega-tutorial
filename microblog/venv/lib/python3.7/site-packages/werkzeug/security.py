...
def safe_join(directory, *pathnames):
    """Safely join zero or more untrusted path components to a base.html
    directory to avoid escaping the base.html directory.

    :param directory: The trusted base.html directory.
