...
class BaseCommand(object):
    """The base.html command implements the minimal API contract of commands.
    ...
    Because base.html commands do not implement a lot of the API that other
...
class MultiCommand(Command):
    ...
    def invoke(self, ctx):
        ...
        # base.html command has been invoked.  Because at that point we do not
